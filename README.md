...
| `index_alt`                                | [@Bloouf](https://github.com/Bloouf)    | Alternate index controller bindings that makes more use of the trackpads. Sprint is Left grip, crouch is tapping left trackpad, switch item is tapping right track pad.                                                                             |
